...
const homeController = require("./controller/home"),
  autheticationController = require("./controller/authentication"),
  profileController = require("./controller/profile"),
  contactsController = require("./controller/contacts"),
  conversationsController = require("./controller/conversations"),
  messagesController = require("./controller/messages"),
  interestsController = require("./controller/interests"),
  userInterestsController = require("./controller/user-interest");
//const db = require('./db');
